...
def plot():
    ...
    baseline_data = [baselines[baselines['approach'] == 'isac'],
                     ...
                     baselines[baselines['approach'] == 'satzilla-11'], baselines[baselines['approach'] == 'sunny'], baselines[baselines['approach'] == 'Expectation_algorithm_survival_forest']]
    ...
    plt.ylim(0.2, 1.7)
    plt.yticks(np.arange(0.2, 1.71, step=0.1))
